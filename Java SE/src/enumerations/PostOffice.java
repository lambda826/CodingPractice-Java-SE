...
class Mail {
    ...
    public static Mail randomMail() {
        Mail m = new Mail();
        m.generalDelivery = RandomGenerator.random(GeneralDelivery.class);
        m.scannability = RandomGenerator.random(Scannability.class);
        m.readability = RandomGenerator.random(Readability.class);
        m.address = RandomGenerator.random(Address.class);
        m.returnAddress = RandomGenerator.random(ReturnAddress.class);
        return m;
    }
